...
void menuList(int cont, int value, int moreOptions)
{
    char menu1[] = "1) Setting automobile\0";
    char menu2[] = "2) Data: 26/05/2023\0";
    char menu3[] = "3) Ora: 14:32\0";
    char menu4[] = "4) Blocco automatico porte\0";
    char menu5[] = "5) Back-home\0";
    char menu6[] = "6) Check olio\0";
    char menu7[] = "7) Frecce direzione:\0";
    char menu8[] = "8) Reset pressione gomme\0";
    char pressione[] = "Pressione gomme resettata\0";
    char supervisor[] = " (supervisor)\0";
    char ON[] = "ON\0";
    char OFF[] = "OFF\0";
